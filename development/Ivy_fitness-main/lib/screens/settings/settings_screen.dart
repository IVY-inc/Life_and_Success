...
import 'package:fitness_flutter/screens/settings/presentation/bloc/settings_bloc.dart';
import 'package:fitness_flutter/screens/settings/presentation/pages/devices.dart';
import 'package:fitness_flutter/screens/settings/presentation/pages/my_data_page.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget _settingsContent(BuildContext context) {
    ...
    final displayName = user?.displayName ?? "Нет имени пользователя";
      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(children: [
            ...
            SizedBox(height: 15),
            SettingsContainer(
              child: Text(TextConstants.myData,
                  style: TextStyle(fontSize: 17, fontWeight: FontWeight.w500)),
              withArrow: true,
              onTap: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (_) => MyDataPage()));
              },
            ),
            SettingsContainer(
              child: Text(TextConstants.devices,
                  style: TextStyle(fontSize: 17, fontWeight: FontWeight.w500)),
              withArrow: true,
              onTap: () {
                Navigator.push(
