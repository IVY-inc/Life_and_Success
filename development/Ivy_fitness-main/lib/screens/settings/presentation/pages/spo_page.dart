...
class _Spo2MeasurementScreenState extends State<Spo2MeasurementScreen> {
  ...
  String getBottomTitle(double value) {
    ...
    return DateFormat('MMM dd').format(date); // Adjust date format as needed
  }
                      ...
                      sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (value, meta) {
                          return SideTitleWidget(
                            ...
                            space: 8.0, // Add some space to prevent overlap
                            child: Text(
                        ...
                        interval: spo2Spots.length > 12 ? spo2Spots.length / 6 : 1, // Adjust interval for better spacing
                      ),
                    ),
                  ),
